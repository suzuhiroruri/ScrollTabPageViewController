...
class BAScoutDetailJobBaseViewController: SJSegmentedViewController {
    ...
    override func viewDidLoad() {
        ...
        let mailViewController = UIViewController()
        mailViewController.view.frame = mailView.frame
        mailViewController.view.addSubview(mailView)
        headerViewController = mailViewController
        headerViewHeight = mailViewController.view.frame.height
...
extension BAScoutDetailJobBaseViewController: SJSegmentedViewControllerDelegate {
